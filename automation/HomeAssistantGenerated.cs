...
//   At: 2024-02-03T12:09:06.0544081+01:00
//
...
public partial class ChimeTtsServices
{
    ...
    ///<param name="offset">Adds a delay between audio segments when value &gt; 0, or overlays audio segments when value &lt; 0. eg: 450</param>
    ...
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public void SayUrl(string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? offset = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, bool? cache = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        _haContext.CallService("chime_tts", "say_url", null, new ChimeTtsSayUrlParameters { ChimePath = chimePath, EndChimePath = endChimePath, Offset = offset, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, Cache = cache, AudioConversion = audioConversion, Language = language, Tld = tld, Gender = gender, Options = options });
    }
}
...
public partial record ChimeTtsSayParameters
{
    ...
    ///<summary>Adds a delay between audio segments when value &gt; 0, or overlays audio segments when value &lt; 0. eg: 450</summary>
