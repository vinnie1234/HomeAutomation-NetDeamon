...
//   At: 2023-10-24T16:57:51.0495750+02:00
//
...
public partial class SensorEntities
{
    ...
    ///<summary>Sync Box Bridge connection</summary>
    public SensorEntity SyncBoxBridgeConnection => new(_haContext, "sensor.sync_box_bridge_connection");
    ///<summary>Sync Box Bridge ID</summary>
    public SensorEntity SyncBoxBridgeId => new(_haContext, "sensor.sync_box_bridge_id");
    ...
    ///<summary>Sync Box IP address</summary>
    public SensorEntity SyncBoxIpAddress => new(_haContext, "sensor.sync_box_ip_address");
    ///<summary>Sync Box Wifi quality</summary>
    public SensorEntity SyncBoxWifiQuality => new(_haContext, "sensor.sync_box_wifi_quality");
...
public partial class ChimeTtsServices
{
    ...
    ///<param name="cache">Whether or not to save the generated audio file in a local cache eg: True</param>
    ///<param name="announce">Stops current media during the announcement and then resume (on supported devices) eg: True</param>
    ///<param name="language">The TTS language (suppored by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: &apos;en&apos; (for Google Translate) or &apos;en-US&apos; (for Microsoft Edge TTS and Nabu Casa Cloud TTS)</param>
    ///<param name="tld">The dialect Domain (suppored by Google Translate) eg: com.uk</param>
    ///<param name="gender">Use a male or female voice (suppored by Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</param>
...
public partial record ChimeTtsSayParameters
{
    ...
    ///<summary>Whether or not to save the generated audio file in a local cache eg: True</summary>
    ...
    ///<summary>The TTS language (suppored by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: &apos;en&apos; (for Google Translate) or &apos;en-US&apos; (for Microsoft Edge TTS and Nabu Casa Cloud TTS)</summary>
    [JsonPropertyName("language")]
    public string? Language { get; init; }

    ///<summary>The dialect Domain (suppored by Google Translate) eg: com.uk</summary>
    [JsonPropertyName("tld")]
    public object? Tld { get; init; }

    ///<summary>Use a male or female voice (suppored by Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</summary>
...
public partial class EpexSpotServices
{
    ...
    ///<param name="earliestStart">Earliest time to start the appliance. eg: 14:00:00</param>
    ///<param name="latestEnd">Latest time to end the appliance. If both times are preset and end time is earlier than (or equal to) start time, end time belongs to tomorrow. eg: 20:00:00</param>
    ///<param name="duration">Required duration to complete appliance. eg: 01:30:00</param>
    public void GetHighestPriceInterval(object duration, string? deviceId = null, DateTime? earliestStart = null, DateTime? latestEnd = null)
    {
        _haContext.CallService("epex_spot", "get_highest_price_interval", null, new EpexSpotGetHighestPriceIntervalParameters { DeviceId = deviceId, EarliestStart = earliestStart, LatestEnd = latestEnd, Duration = duration });
    }
    ...
    ///<param name="latestEnd">Latest time to end the appliance. If both times are preset and end time is earlier than (or equal to) start time, end time belongs to tomorrow. eg: 20:00:00</param>
    ///<param name="duration">Required duration to complete appliance. eg: 01:30:00</param>
    public void GetLowestPriceInterval(object duration, string? deviceId = null, DateTime? earliestStart = null, DateTime? latestEnd = null)
    {
        _haContext.CallService("epex_spot", "get_lowest_price_interval", null, new EpexSpotGetLowestPriceIntervalParameters { DeviceId = deviceId, EarliestStart = earliestStart, LatestEnd = latestEnd, Duration = duration });
    }
}
...
public partial record EpexSpotGetHighestPriceIntervalParameters
{
    ...
    ///<summary>Earliest time to start the appliance. eg: 14:00:00</summary>
    [JsonPropertyName("earliest_start")]
    public DateTime? EarliestStart { get; init; }

    ///<summary>Latest time to end the appliance. If both times are preset and end time is earlier than (or equal to) start time, end time belongs to tomorrow. eg: 20:00:00</summary>
