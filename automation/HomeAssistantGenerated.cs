...
//   At: 2023-12-22T21:46:18.0339307+01:00
//
...
public partial class ChimeTtsServices
{
    ...
    ///<param name="language">The TTS language (supported by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: &apos;en&apos; (for Google Translate) or &apos;en-US&apos; (for Microsoft Edge TTS and Nabu Casa Cloud TTS)</param>
    ///<param name="tld">The dialect Domain (supported by Google Translate) eg: com.uk</param>
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</param>
    ...
    ///<param name="delay">Delay (ms) between the chime/s and the TTS message eg: 450</param>
    ///<param name="finalDelay">Final delay (ms) added to the end of the audio eg: 100</param>
    ///<param name="message">Text converted into TTS audio eg: Hello world!</param>
    ///<param name="ttsPlatform">TTS platform used to generate TTS audio eg: google_translate</param>
    ///<param name="ttsPlaybackSpeed">Playback speed of the TTS audio, between 100% - 200% eg: 125</param>
    ///<param name="cache">Whether or not to save/reuse the generated audio file in a local cache eg: True</param>
    ///<param name="language">The TTS language (supported by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: &apos;en&apos; (for Google Translate) or &apos;en-US&apos; (for Microsoft Edge TTS and Nabu Casa Cloud TTS)</param>
    ///<param name="tld">The dialect Domain (supported by Google Translate) eg: com.uk</param>
    ///<param name="gender">Use a male or female voice (Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public void SayUrl(string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, bool? cache = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        _haContext.CallService("chime_tts", "say_url", null, new ChimeTtsSayUrlParameters { ChimePath = chimePath, EndChimePath = endChimePath, Delay = delay, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, Cache = cache, Language = language, Tld = tld, Gender = gender, Options = options });
    }
}
...
public partial record ChimeTtsSayParameters
{
    ...
    ///<summary>The TTS language (supported by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: &apos;en&apos; (for Google Translate) or &apos;en-US&apos; (for Microsoft Edge TTS and Nabu Casa Cloud TTS)</summary>
    [JsonPropertyName("language")]
    public string? Language { get; init; }

    ///<summary>The dialect Domain (supported by Google Translate) eg: com.uk</summary>
    [JsonPropertyName("tld")]
    public object? Tld { get; init; }

    ///<summary>Use a male or female voice (supported by Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</summary>
...
public partial record ChimeTtsSayUrlParameters
{
    ...
    ///<summary>Text converted into TTS audio eg: Hello world!</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
    ...
    ///<summary>Use a male or female voice (Nabu Casa) eg: &apos;male&apos; or &apos;female&apos;</summary>
    [JsonPropertyName("gender")]
    public object? Gender { get; init; }
