...
//   At: 2023-05-30T20:44:37.0315440+02:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Protection window</summary>
    ...
    ///<summary>VINCENT-NAS (Schijf 1) Below min remaining life</summary>
    ...
    ///<summary>VINCENT-NAS (Schijf 1) Exceeded max bad sectors</summary>
    ...
    public BinarySensorEntity VincentNasSecurityStatus => new(_haContext, "binary_sensor.vincent_nas_security_status");
    ...
    ///<summary>ZEDAR Battery Available</summary>
    public BinarySensorEntity ZedarBatteryAvailable => new(_haContext, "binary_sensor.zedar_battery_available");
    ///<summary>ZEDAR feed container</summary>
    public BinarySensorEntity ZedarFeedContainer => new(_haContext, "binary_sensor.zedar_feed_container");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>ZedarSkipNextAutoFeed</summary>
    public InputBooleanEntity Zedarskipnextautofeed => new(_haContext, "input_boolean.zedarskipnextautofeed");
}
...
public partial class InputButtonEntities
{
    ...
    ///<summary>ZedarGiveNextFeedEary</summary>
    public InputButtonEntity Zedargivenextfeedeary => new(_haContext, "input_button.zedargivenextfeedeary");
}
...
public partial class InputDatetimeEntities
{
    ...
    ///<summary>ZedarFeedFirstTime</summary>
    public InputDatetimeEntity Zedarfeedfirsttime => new(_haContext, "input_datetime.zedarfeedfirsttime");
    ///<summary>ZedarFeedFourthTime</summary>
    public InputDatetimeEntity Zedarfeedfourthtime => new(_haContext, "input_datetime.zedarfeedfourthtime");
    ///<summary>ZedarFeedSecondTime</summary>
    public InputDatetimeEntity Zedarfeedsecondtime => new(_haContext, "input_datetime.zedarfeedsecondtime");
    ///<summary>ZedarFeedThirdTime</summary>
    public InputDatetimeEntity Zedarfeedthirdtime => new(_haContext, "input_datetime.zedarfeedthirdtime");
    ///<summary>ZedarLastAutomatedFeed</summary>
    public InputDatetimeEntity Zedarlastautomatedfeed => new(_haContext, "input_datetime.zedarlastautomatedfeed");
    ///<summary>ZedarLastManualFeed</summary>
    public InputDatetimeEntity Zedarlastmanualfeed => new(_haContext, "input_datetime.zedarlastmanualfeed");
}
...
public partial class InputNumberEntities
{
    ...
    ///<summary>ZedarFeedFirstAmound</summary>
    public InputNumberEntity Zedarfeedfirstamound => new(_haContext, "input_number.zedarfeedfirstamound");
    ///<summary>ZedarFeedFourthAmound</summary>
    public InputNumberEntity Zedarfeedfourthamound => new(_haContext, "input_number.zedarfeedfourthamound");
    ///<summary>ZedarFeedSecondAmound</summary>
    public InputNumberEntity Zedarfeedsecondamound => new(_haContext, "input_number.zedarfeedsecondamound");
    ///<summary>ZedarFeedThirdAmound</summary>
    public InputNumberEntity Zedarfeedthirdamound => new(_haContext, "input_number.zedarfeedthirdamound");
    ///<summary>ZedarLastAmountAutomationFeed</summary>
    public InputNumberEntity Zedarlastamountautomationfeed => new(_haContext, "input_number.zedarlastamountautomationfeed");
    ///<summary>ZedarLastAmountManualFeed</summary>
    public InputNumberEntity Zedarlastamountmanualfeed => new(_haContext, "input_number.zedarlastamountmanualfeed");
    ///<summary>ZedarTotalAmountFeedAllTime</summary>
    public InputNumberEntity Zedartotalamountfeedalltime => new(_haContext, "input_number.zedartotalamountfeedalltime");
    ///<summary>ZedarTotalAmountFeedDay</summary>
    public InputNumberEntity Zedartotalamountfeedday => new(_haContext, "input_number.zedartotalamountfeedday");
}
...
public partial class LightEntities
{
    ...
    ///<summary>TRADFRI driver</summary>
    public LightEntity TradfriDriver => new(_haContext, "light.tradfri_driver");
    ///<summary>TV</summary>
...
public partial class MediaPlayerEntities
{
    ...
    ///<summary>Sync Box</summary>
    public MediaPlayerEntity SyncBox => new(_haContext, "media_player.sync_box");
...
public partial class NumberEntities
{
    ...
    ///<summary>EnergySocket (5c2faf02a546) Status light brightness</summary>
    ...
    ///<summary>EnergySocket (5c2faf0c7564) Status light brightness</summary>
    ...
    ///<summary>EnergySocket (5c2faf0d8364) Status light brightness</summary>
    ...
    ///<summary>Hoeveel handmatig voer</summary>
    public NumberEntity ZedarManualFeedAmount => new(_haContext, "number.zedar_manual_feed_amount");
    ///<summary>ZEDAR Voice time</summary>
    public NumberEntity ZedarVoiceTime => new(_haContext, "number.zedar_voice_time");
}
...
public partial class SensorEntities
{
    ...
    ///<summary>Home Assistant Information Areas</summary>
    public SensorEntity Areas => new(_haContext, "sensor.areas");
    ///<summary>Home Assistant Information Automations</summary>
    ...
    ///<summary>Home Assistant Information Binary sensors</summary>
    public SensorEntity BinarySensors => new(_haContext, "sensor.binary_sensors");
    ///<summary>Buienradar Barometer</summary>
    ...
    ///<summary>Home Assistant Information Entities</summary>
    public SensorEntity Entities => new(_haContext, "sensor.entities");
    ///<summary>EPEX Spot NL Quantile</summary>
    public SensorEntity EpexSpotNlQuantile => new(_haContext, "sensor.epex_spot_nl_quantile");
    ///<summary>EPEX Spot NL Rank</summary>
    public SensorEntity EpexSpotNlRank => new(_haContext, "sensor.epex_spot_nl_rank");
    ///<summary>Home Assistant Information Fans</summary>
    ...
    ///<summary>Hub Vincent timers</summary>
    public SensorEntity HubVincentTimers => new(_haContext, "sensor.hub_vincent_timers");
    ///<summary>Home Assistant Information Humidifiers</summary>
    public SensorEntity Humidifiers => new(_haContext, "sensor.humidifiers");
    ///<summary>Home Assistant Information Integrations</summary>
    ...
    ///<summary>Home Assistant Information Lights</summary>
    public SensorEntity Lights => new(_haContext, "sensor.lights");
    ///<summary>Home Assistant Information Locks</summary>
    ...
    ///<summary>Home Assistant Information Media players</summary>
    ...
    ///<summary>Home Assistant Information Numbers</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Power failures detected</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Smart meter identifier</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Smart meter model</summary>
    public SensorEntity P1Meter3c39e72a64e8SmartMeterModel => new(_haContext, "sensor.p1_meter_3c39e72a64e8_smart_meter_model");
    ///<summary>P1 meter (3c39e72a64e8) Voltage sags detected L1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Voltage sags detected L2</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Voltage sags detected L3</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Voltage swells detected L1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Voltage swells detected L2</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Voltage swells detected L3</summary>
    ...
    ///<summary>Home Assistant Information Persons</summary>
    ...
    ///<summary>Home Assistant Information Remotes</summary>
    ...
    ///<summary>Home Assistant Information Suns</summary>
    public SensorEntity Suns => new(_haContext, "sensor.suns");
    ///<summary>Home Assistant Information Switches</summary>
    public SensorEntity Switches => new(_haContext, "sensor.switches");
    ///<summary>Home Assistant Information Texts</summary>
    ...
    ///<summary>Home Assistant Information Update</summary>
    public SensorEntity Update => new(_haContext, "sensor.update");
    ///<summary>Home Assistant Information Vacuums</summary>
    ...
    ///<summary>Home Assistant Information Water heaters</summary>
    ...
    ///<summary>Home Assistant Information Weather</summary>
    public SensorEntity Weather => new(_haContext, "sensor.weather");
    ///<summary>Woonkamer alarms</summary>
    public SensorEntity WoonkamerAlarms => new(_haContext, "sensor.woonkamer_alarms");
    ///<summary>Woonkamer device</summary>
    public SensorEntity WoonkamerDevice => new(_haContext, "sensor.woonkamer_device");
    ///<summary>Woonkamer timers</summary>
    public SensorEntity WoonkamerTimers => new(_haContext, "sensor.woonkamer_timers");
    ///<summary>ZEDAR Last amount auto feed</summary>
    public SensorEntity ZedarLastAmountAutoFeed => new(_haContext, "sensor.zedar_last_amount_auto_feed");
    ///<summary>ZEDAR last amount manual feed</summary>
    public SensorEntity ZedarLastAmountManualFeed => new(_haContext, "sensor.zedar_last_amount_manual_feed");
    ///<summary>Home Assistant Information Zones</summary>
    ...
    ///<summary>Buienradar Precipitation forecast total</summary>
    ...
    ///<summary>EnergySocket (5c2faf02a546) Active power</summary>
    ...
    ///<summary>EnergySocket (5c2faf02a546) Active power L1</summary>
    ...
    ///<summary>EnergySocket (5c2faf0c7564) Active power</summary>
    ...
    ///<summary>EnergySocket (5c2faf0c7564) Active power L1</summary>
    ...
    ///<summary>EnergySocket (5c2faf0d8364) Active power</summary>
    ...
    ///<summary>EnergySocket (5c2faf0d8364) Active power L1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Total power export T1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Total power export T2</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Total power import</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Total power import T1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Total power import T2</summary>
    ...
    public NumericSensorEntity VincentNasCpuUtilizationTotal => new(_haContext, "sensor.vincent_nas_cpu_utilization_total");
    ///<summary>VINCENT-NAS CPU-gebruik (gebruiker)</summary>
    public NumericSensorEntity VincentNasCpuUtilizationUser => new(_haContext, "sensor.vincent_nas_cpu_utilization_user");
    ///<summary>VINCENT-NAS Download throughput</summary>
    ...
    public NumericSensorEntity VincentNasMemoryAvailableReal => new(_haContext, "sensor.vincent_nas_memory_available_real");
    ///<summary>VINCENT-NAS Geheugen beschikbaar (swap)</summary>
    public NumericSensorEntity VincentNasMemoryAvailableSwap => new(_haContext, "sensor.vincent_nas_memory_available_swap");
    ///<summary>VINCENT-NAS Memory total (real)</summary>
    public NumericSensorEntity VincentNasMemoryTotalReal => new(_haContext, "sensor.vincent_nas_memory_total_real");
    ///<summary>VINCENT-NAS Memory total (swap)</summary>
    ...
    public NumericSensorEntity VincentNasMemoryUsageReal => new(_haContext, "sensor.vincent_nas_memory_usage_real");
    ///<summary>VINCENT-NAS (Schijf 1) Temperatuur</summary>
    public NumericSensorEntity VincentNasSchijf1Temperature => new(_haContext, "sensor.vincent_nas_schijf_1_temperature");
    ///<summary>VINCENT-NAS Temperatuur</summary>
    public NumericSensorEntity VincentNasTemperature => new(_haContext, "sensor.vincent_nas_temperature");
    ///<summary>VINCENT-NAS Upload throughput</summary>
    public NumericSensorEntity VincentNasUploadThroughput => new(_haContext, "sensor.vincent_nas_upload_throughput");
    ///<summary>VINCENT-NAS (Volume 1) Average disk temp</summary>
    ...
    public NumericSensorEntity VincentNasVolume1UsedSpace => new(_haContext, "sensor.vincent_nas_volume_1_used_space");
    ///<summary>VINCENT-NAS (Volume 1) Volume gebruikt</summary>
    public NumericSensorEntity VincentNasVolume1VolumeUsed => new(_haContext, "sensor.vincent_nas_volume_1_volume_used");
    ///<summary>Vitens water price</summary>
    public NumericSensorEntity VitensWaterPrice => new(_haContext, "sensor.vitens_water_price");
    ...
    ///<summary>Watermeter (5c2faf0e9b0a) Active water usage</summary>
    ...
    ///<summary>Watermeter (5c2faf0e9b0a) Total water usage</summary>
...
public partial class SwitchEntities
{
    ...
    ///<summary>Warmtepomp Energie</summary>
    public SwitchEntity Energysocket5c2faf02a546 => new(_haContext, "switch.energysocket_5c2faf02a546");
    ///<summary>EnergySocket (5c2faf02a546) Cloud connection</summary>
    ...
    ///<summary>EnergySocket (5c2faf02a546) Switch lock</summary>
    public SwitchEntity Energysocket5c2faf02a546SwitchLock => new(_haContext, "switch.energysocket_5c2faf02a546_switch_lock");
    ///<summary>Ventilatie Energie</summary>
    public SwitchEntity Energysocket5c2faf0c7564 => new(_haContext, "switch.energysocket_5c2faf0c7564");
    ///<summary>EnergySocket (5c2faf0c7564) Cloud connection</summary>
    ...
    ///<summary>EnergySocket (5c2faf0c7564) Switch lock</summary>
    public SwitchEntity Energysocket5c2faf0c7564SwitchLock => new(_haContext, "switch.energysocket_5c2faf0c7564_switch_lock");
    ///<summary>Gaming hoek Energie</summary>
    public SwitchEntity Energysocket5c2faf0d8364 => new(_haContext, "switch.energysocket_5c2faf0d8364");
    ///<summary>EnergySocket (5c2faf0d8364) Cloud connection</summary>
    ...
    ///<summary>EnergySocket (5c2faf0d8364) Switch lock</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Cloud connection</summary>
...
public partial class UpdateEntities
{
    ...
    ///<summary>Google Assistant SDK Update</summary>
...
public partial record SensorAttributes
{
    ...
    public string? TvNetwork { get; init; }
...
public partial class HuesyncboxServices
{
    ...
    ///<summary>Set the bridge to be used by the Philips Hue Play HDMI Syncbox. Keep in mind that changing the bridge by the box takes a while (about 15 seconds it seems). After the bridge has changed you might need to select the `entertainment_area` if connectionstate is `invalidgroup` instead of `connected`.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="bridgeId">ID of the bridge. A hexadecimal code of 16 characters. eg: 001788FFFE123456</param>
    ...
    ///<param name="bridgeClientkey">Clientkey corresponeding with the username. A hexadecimal code of 32 characters. eg: 00112233445566778899AABBCCDDEEFF</param>
    ...
    ///<summary>Set brightness for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    public void SetBrightness(ServiceTarget target, HuesyncboxSetBrightnessParameters data)
    {
        _haContext.CallService("huesyncbox", "set_brightness", target, data);
    }

    ///<summary>Set brightness for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="brightness">Brightness value to set [0,1]. eg: 0.42</param>
    public void SetBrightness(ServiceTarget target, double brightness)
    {
        _haContext.CallService("huesyncbox", "set_brightness", target, new HuesyncboxSetBrightnessParameters { Brightness = brightness });
    }

    ///<summary>Set entertainment area to be used for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    public void SetEntertainmentArea(ServiceTarget target, HuesyncboxSetEntertainmentAreaParameters data)
    {
        _haContext.CallService("huesyncbox", "set_entertainment_area", target, data);
    }

    ///<summary>Set entertainment area to be used for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="entertainmentArea">Entertainment area to select. Must be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public void SetEntertainmentArea(ServiceTarget target, string entertainmentArea)
    {
        _haContext.CallService("huesyncbox", "set_entertainment_area", target, new HuesyncboxSetEntertainmentAreaParameters { EntertainmentArea = entertainmentArea });
    }

    ///<summary>Set intensity for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    public void SetIntensity(ServiceTarget target, HuesyncboxSetIntensityParameters data)
    {
        _haContext.CallService("huesyncbox", "set_intensity", target, data);
    }

    ///<summary>Set intensity for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="intensity">Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</param>
    ///<param name="mode">Optional mode to apply intensity to. If not set intensity is applied to current/last used mode. eg: video</param>
    public void SetIntensity(ServiceTarget target, object intensity, object? mode = null)
    {
        _haContext.CallService("huesyncbox", "set_intensity", target, new HuesyncboxSetIntensityParameters { Intensity = intensity, Mode = mode });
    }

    ///<summary>Set syncmode for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    public void SetSyncMode(ServiceTarget target, HuesyncboxSetSyncModeParameters data)
    {
        _haContext.CallService("huesyncbox", "set_sync_mode", target, data);
    }

    ///<summary>Set syncmode for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="mode">Mode to set. One of &apos;video&apos;, &apos;music&apos;, &apos;game&apos;. eg: video</param>
    public void SetSyncMode(ServiceTarget target, object mode)
    {
        _haContext.CallService("huesyncbox", "set_sync_mode", target, new HuesyncboxSetSyncModeParameters { Mode = mode });
    }

    ///<summary>Control the complete sync state of the Philips Hue Play HDMI Syncbox. This is an advanced service and contains potential conflicting fields. Use responsibly!</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Control the complete sync state of the Philips Hue Play HDMI Syncbox. This is an advanced service and contains potential conflicting fields. Use responsibly!</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="sync">Set sync state on or off. eg: True</param>
    ///<param name="syncToggle">Toggle sync state between on/off. eg: True</param>
    ///<param name="brightness">Brightness value to set [0,1]. eg: 0.42</param>
    ///<param name="brightnessStep">Change brightness relative to the current state. Should be between -1..1. eg: -0.2</param>
    ///<param name="mode">Mode to set. One of &apos;video&apos;, &apos;music&apos;, &apos;game&apos;. eg: video</param>
    ///<param name="modeNext">Select next mode, will wrap around. eg: True</param>
    ///<param name="modePrev">Select previous mode, will wrap around. eg: True</param>
    ///<param name="intensity">Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</param>
    ///<param name="intensityNext">Select next intensity. eg: True</param>
    ///<param name="intensityPrev">Select previous intensity. eg: True</param>
    ///<param name="input">Input to select. One of &apos;input1&apos;, &apos;input2&apos;, &apos;input3&apos;, &apos;input4&apos;. eg: input1</param>
    ///<param name="inputNext">Select next input, wraps around. eg: True</param>
    ///<param name="inputPrev">Select previous input, wraps around. eg: True</param>
    ///<param name="entertainmentArea">Entertainment area to select. Can be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public void SetSyncState(ServiceTarget target, bool? sync = null, bool? syncToggle = null, double? brightness = null, double? brightnessStep = null, object? mode = null, bool? modeNext = null, bool? modePrev = null, object? intensity = null, bool? intensityNext = null, bool? intensityPrev = null, object? input = null, bool? inputNext = null, bool? inputPrev = null, string? entertainmentArea = null)
    {
        _haContext.CallService("huesyncbox", "set_sync_state", target, new HuesyncboxSetSyncStateParameters { Sync = sync, SyncToggle = syncToggle, Brightness = brightness, BrightnessStep = brightnessStep, Mode = mode, ModeNext = modeNext, ModePrev = modePrev, Intensity = intensity, IntensityNext = intensityNext, IntensityPrev = intensityPrev, Input = input, InputNext = inputNext, InputPrev = inputPrev, EntertainmentArea = entertainmentArea });
    }
}

public partial record HuesyncboxSetBridgeParameters
{
    ///<summary>ID of the bridge. A hexadecimal code of 16 characters. eg: 001788FFFE123456</summary>
    ...
    ///<summary>Clientkey corresponeding with the username. A hexadecimal code of 32 characters. eg: 00112233445566778899AABBCCDDEEFF</summary>
    [JsonPropertyName("bridge_clientkey")]
    public string? BridgeClientkey { get; init; }
}

public partial record HuesyncboxSetBrightnessParameters
{
    ///<summary>Brightness value to set [0,1]. eg: 0.42</summary>
    [JsonPropertyName("brightness")]
    public double? Brightness { get; init; }
}

public partial record HuesyncboxSetEntertainmentAreaParameters
{
    ///<summary>Entertainment area to select. Must be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</summary>
    [JsonPropertyName("entertainment_area")]
    public string? EntertainmentArea { get; init; }
}

public partial record HuesyncboxSetIntensityParameters
{
    ///<summary>Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</summary>
    [JsonPropertyName("intensity")]
    public object? Intensity { get; init; }

    ///<summary>Optional mode to apply intensity to. If not set intensity is applied to current/last used mode. eg: video</summary>
    [JsonPropertyName("mode")]
    public object? Mode { get; init; }
}

public partial record HuesyncboxSetSyncModeParameters
{
    ///<summary>Mode to set. One of &apos;video&apos;, &apos;music&apos;, &apos;game&apos;. eg: video</summary>
    [JsonPropertyName("mode")]
    public object? Mode { get; init; }
}
...
{
    ///<summary>Set sync state on or off. eg: True</summary>
    [JsonPropertyName("sync")]
    public bool? Sync { get; init; }

    ///<summary>Toggle sync state between on/off. eg: True</summary>
    [JsonPropertyName("sync_toggle")]
    public bool? SyncToggle { get; init; }

    ///<summary>Brightness value to set [0,1]. eg: 0.42</summary>
    [JsonPropertyName("brightness")]
    public double? Brightness { get; init; }

    ///<summary>Change brightness relative to the current state. Should be between -1..1. eg: -0.2</summary>
    ...
    ///<summary>Select next mode, will wrap around. eg: True</summary>
    [JsonPropertyName("mode_next")]
    public bool? ModeNext { get; init; }

    ///<summary>Select previous mode, will wrap around. eg: True</summary>
    [JsonPropertyName("mode_prev")]
    public bool? ModePrev { get; init; }

    ///<summary>Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</summary>
    [JsonPropertyName("intensity")]
    public object? Intensity { get; init; }

    ///<summary>Select next intensity. eg: True</summary>
    [JsonPropertyName("intensity_next")]
    public bool? IntensityNext { get; init; }

    ///<summary>Select previous intensity. eg: True</summary>
    [JsonPropertyName("intensity_prev")]
    public bool? IntensityPrev { get; init; }

    ///<summary>Input to select. One of &apos;input1&apos;, &apos;input2&apos;, &apos;input3&apos;, &apos;input4&apos;. eg: input1</summary>
    [JsonPropertyName("input")]
    public object? Input { get; init; }

    ///<summary>Select next input, wraps around. eg: True</summary>
    [JsonPropertyName("input_next")]
    public bool? InputNext { get; init; }

    ///<summary>Select previous input, wraps around. eg: True</summary>
    [JsonPropertyName("input_prev")]
    public bool? InputPrev { get; init; }

    ///<summary>Entertainment area to select. Can be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</summary>
    [JsonPropertyName("entertainment_area")]
    public string? EntertainmentArea { get; init; }
}
...
public partial class MotionBlindsServices
{
    ...
    ///<summary>Set the absolute position of the cover.</summary>
    ///<param name="target">The target for this service call</param>
...
public partial class ShellCommandServices
{
    ...
    public void MountNasMovie()
    {
        _haContext.CallService("shell_command", "mount_nas_movie", null);
    }
}
...
public static class HuesyncboxEntityExtensionMethods
{
    ///<summary>Set the bridge to be used by the Philips Hue Play HDMI Syncbox. Keep in mind that changing the bridge by the box takes a while (about 15 seconds it seems). After the bridge has changed you might need to select the `entertainment_area` if connectionstate is `invalidgroup` instead of `connected`.</summary>
    public static void SetBridge(this MediaPlayerEntity target, HuesyncboxSetBridgeParameters data)
    {
        target.CallService("set_bridge", data);
    }

    ///<summary>Set the bridge to be used by the Philips Hue Play HDMI Syncbox. Keep in mind that changing the bridge by the box takes a while (about 15 seconds it seems). After the bridge has changed you might need to select the `entertainment_area` if connectionstate is `invalidgroup` instead of `connected`.</summary>
    public static void SetBridge(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetBridgeParameters data)
    {
        target.CallService("set_bridge", data);
    }
    ...
    ///<param name="bridgeUsername">Username (a.k.a. application key) valid for the bridge. A long code of random characters. eg: WB9xS1t0Baw-8ZqYKMcEhOaKRU42E84-NZBXwcIL</param>
    ///<param name="bridgeClientkey">Clientkey corresponeding with the username. A hexadecimal code of 32 characters. eg: 00112233445566778899AABBCCDDEEFF</param>
    public static void SetBridge(this MediaPlayerEntity target, string bridgeId, string bridgeUsername, string bridgeClientkey)
    {
        target.CallService("set_bridge", new HuesyncboxSetBridgeParameters { BridgeId = bridgeId, BridgeUsername = bridgeUsername, BridgeClientkey = bridgeClientkey });
    }
    ...
    ///<param name="bridgeUsername">Username (a.k.a. application key) valid for the bridge. A long code of random characters. eg: WB9xS1t0Baw-8ZqYKMcEhOaKRU42E84-NZBXwcIL</param>
    ///<param name="bridgeClientkey">Clientkey corresponeding with the username. A hexadecimal code of 32 characters. eg: 00112233445566778899AABBCCDDEEFF</param>
    public static void SetBridge(this IEnumerable<MediaPlayerEntity> target, string bridgeId, string bridgeUsername, string bridgeClientkey)
    {
        target.CallService("set_bridge", new HuesyncboxSetBridgeParameters { BridgeId = bridgeId, BridgeUsername = bridgeUsername, BridgeClientkey = bridgeClientkey });
    }

    ///<summary>Set brightness for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetBrightness(this MediaPlayerEntity target, HuesyncboxSetBrightnessParameters data)
    {
        target.CallService("set_brightness", data);
    }

    ///<summary>Set brightness for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetBrightness(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetBrightnessParameters data)
    {
        target.CallService("set_brightness", data);
    }
    ...
    ///<param name="target">The MediaPlayerEntity to call this service for</param>
    ///<param name="brightness">Brightness value to set [0,1]. eg: 0.42</param>
    public static void SetBrightness(this MediaPlayerEntity target, double brightness)
    {
        target.CallService("set_brightness", new HuesyncboxSetBrightnessParameters { Brightness = brightness });
    }

    ///<summary>Set brightness for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The IEnumerable&lt;MediaPlayerEntity&gt; to call this service for</param>
    ///<param name="brightness">Brightness value to set [0,1]. eg: 0.42</param>
    public static void SetBrightness(this IEnumerable<MediaPlayerEntity> target, double brightness)
    {
        target.CallService("set_brightness", new HuesyncboxSetBrightnessParameters { Brightness = brightness });
    }

    ///<summary>Set entertainment area to be used for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetEntertainmentArea(this MediaPlayerEntity target, HuesyncboxSetEntertainmentAreaParameters data)
    {
        target.CallService("set_entertainment_area", data);
    }

    ///<summary>Set entertainment area to be used for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetEntertainmentArea(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetEntertainmentAreaParameters data)
    {
        target.CallService("set_entertainment_area", data);
    }
    ...
    ///<param name="target">The MediaPlayerEntity to call this service for</param>
    ///<param name="entertainmentArea">Entertainment area to select. Must be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public static void SetEntertainmentArea(this MediaPlayerEntity target, string entertainmentArea)
    {
        target.CallService("set_entertainment_area", new HuesyncboxSetEntertainmentAreaParameters { EntertainmentArea = entertainmentArea });
    }

    ///<summary>Set entertainment area to be used for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The IEnumerable&lt;MediaPlayerEntity&gt; to call this service for</param>
    ///<param name="entertainmentArea">Entertainment area to select. Must be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public static void SetEntertainmentArea(this IEnumerable<MediaPlayerEntity> target, string entertainmentArea)
    {
        target.CallService("set_entertainment_area", new HuesyncboxSetEntertainmentAreaParameters { EntertainmentArea = entertainmentArea });
    }

    ///<summary>Set intensity for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetIntensity(this MediaPlayerEntity target, HuesyncboxSetIntensityParameters data)
    {
        target.CallService("set_intensity", data);
    }

    ///<summary>Set intensity for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetIntensity(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetIntensityParameters data)
    {
        target.CallService("set_intensity", data);
    }
    ...
    ///<param name="intensity">Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</param>
    ///<param name="mode">Optional mode to apply intensity to. If not set intensity is applied to current/last used mode. eg: video</param>
    public static void SetIntensity(this MediaPlayerEntity target, object intensity, object? mode = null)
    {
        target.CallService("set_intensity", new HuesyncboxSetIntensityParameters { Intensity = intensity, Mode = mode });
    }
    ...
    ///<param name="intensity">Intensity to set. One of &apos;subtle&apos;, &apos;moderate&apos;, &apos;high&apos;, &apos;intense&apos;. eg: high</param>
    ///<param name="mode">Optional mode to apply intensity to. If not set intensity is applied to current/last used mode. eg: video</param>
    public static void SetIntensity(this IEnumerable<MediaPlayerEntity> target, object intensity, object? mode = null)
    {
        target.CallService("set_intensity", new HuesyncboxSetIntensityParameters { Intensity = intensity, Mode = mode });
    }

    ///<summary>Set syncmode for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetSyncMode(this MediaPlayerEntity target, HuesyncboxSetSyncModeParameters data)
    {
        target.CallService("set_sync_mode", data);
    }

    ///<summary>Set syncmode for the Philips Hue Play HDMI Syncbox.</summary>
    public static void SetSyncMode(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetSyncModeParameters data)
    {
        target.CallService("set_sync_mode", data);
    }
    ...
    ///<param name="target">The MediaPlayerEntity to call this service for</param>
    ///<param name="mode">Mode to set. One of &apos;video&apos;, &apos;music&apos;, &apos;game&apos;. eg: video</param>
    public static void SetSyncMode(this MediaPlayerEntity target, object mode)
    {
        target.CallService("set_sync_mode", new HuesyncboxSetSyncModeParameters { Mode = mode });
    }

    ///<summary>Set syncmode for the Philips Hue Play HDMI Syncbox.</summary>
    ///<param name="target">The IEnumerable&lt;MediaPlayerEntity&gt; to call this service for</param>
    ///<param name="mode">Mode to set. One of &apos;video&apos;, &apos;music&apos;, &apos;game&apos;. eg: video</param>
    public static void SetSyncMode(this IEnumerable<MediaPlayerEntity> target, object mode)
    {
        target.CallService("set_sync_mode", new HuesyncboxSetSyncModeParameters { Mode = mode });
    }

    ///<summary>Control the complete sync state of the Philips Hue Play HDMI Syncbox. This is an advanced service and contains potential conflicting fields. Use responsibly!</summary>
    public static void SetSyncState(this MediaPlayerEntity target, HuesyncboxSetSyncStateParameters data)
    {
        target.CallService("set_sync_state", data);
    }

    ///<summary>Control the complete sync state of the Philips Hue Play HDMI Syncbox. This is an advanced service and contains potential conflicting fields. Use responsibly!</summary>
    public static void SetSyncState(this IEnumerable<MediaPlayerEntity> target, HuesyncboxSetSyncStateParameters data)
    {
        target.CallService("set_sync_state", data);
    }
    ...
    ///<param name="inputPrev">Select previous input, wraps around. eg: True</param>
    ///<param name="entertainmentArea">Entertainment area to select. Can be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public static void SetSyncState(this MediaPlayerEntity target, bool? sync = null, bool? syncToggle = null, double? brightness = null, double? brightnessStep = null, object? mode = null, bool? modeNext = null, bool? modePrev = null, object? intensity = null, bool? intensityNext = null, bool? intensityPrev = null, object? input = null, bool? inputNext = null, bool? inputPrev = null, string? entertainmentArea = null)
    {
        target.CallService("set_sync_state", new HuesyncboxSetSyncStateParameters { Sync = sync, SyncToggle = syncToggle, Brightness = brightness, BrightnessStep = brightnessStep, Mode = mode, ModeNext = modeNext, ModePrev = modePrev, Intensity = intensity, IntensityNext = intensityNext, IntensityPrev = intensityPrev, Input = input, InputNext = inputNext, InputPrev = inputPrev, EntertainmentArea = entertainmentArea });
    }
    ...
    ///<param name="inputPrev">Select previous input, wraps around. eg: True</param>
    ///<param name="entertainmentArea">Entertainment area to select. Can be one of the names available in &apos;entertainment_area_list&apos; attribute. eg: TV Area</param>
    public static void SetSyncState(this IEnumerable<MediaPlayerEntity> target, bool? sync = null, bool? syncToggle = null, double? brightness = null, double? brightnessStep = null, object? mode = null, bool? modeNext = null, bool? modePrev = null, object? intensity = null, bool? intensityNext = null, bool? intensityPrev = null, object? input = null, bool? inputNext = null, bool? inputPrev = null, string? entertainmentArea = null)
    {
        target.CallService("set_sync_state", new HuesyncboxSetSyncStateParameters { Sync = sync, SyncToggle = syncToggle, Brightness = brightness, BrightnessStep = brightnessStep, Mode = mode, ModeNext = modeNext, ModePrev = modePrev, Intensity = intensity, IntensityNext = intensityNext, IntensityPrev = intensityPrev, Input = input, InputNext = inputNext, InputPrev = inputPrev, EntertainmentArea = entertainmentArea });
    }
}
