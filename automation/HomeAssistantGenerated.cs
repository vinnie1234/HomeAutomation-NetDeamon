...
//   At: 2024-01-21T21:49:33.0813169+01:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Phone Vincent Android Auto</summary>
    public BinarySensorEntity PhoneVincentAndroidAuto => new(_haContext, "binary_sensor.phone_vincent_android_auto");
    ///<summary>Phone Vincent Bluetooth state</summary>
    public BinarySensorEntity PhoneVincentBluetoothState => new(_haContext, "binary_sensor.phone_vincent_bluetooth_state");
    ///<summary>Phone Vincent Headphones</summary>
    public BinarySensorEntity PhoneVincentHeadphones => new(_haContext, "binary_sensor.phone_vincent_headphones");
    ///<summary>Phone Vincent Is charging</summary>
    public BinarySensorEntity PhoneVincentIsCharging => new(_haContext, "binary_sensor.phone_vincent_is_charging");
    ///<summary>Phone Vincent Mic muted</summary>
    public BinarySensorEntity PhoneVincentMicMuted => new(_haContext, "binary_sensor.phone_vincent_mic_muted");
    ///<summary>Phone Vincent Mobile data</summary>
    public BinarySensorEntity PhoneVincentMobileData => new(_haContext, "binary_sensor.phone_vincent_mobile_data");
    ///<summary>Phone Vincent Music active</summary>
    public BinarySensorEntity PhoneVincentMusicActive => new(_haContext, "binary_sensor.phone_vincent_music_active");
    ///<summary>Phone Vincent Speakerphone</summary>
    public BinarySensorEntity PhoneVincentSpeakerphone => new(_haContext, "binary_sensor.phone_vincent_speakerphone");
    ///<summary>Phone Vincent WiFi state</summary>
    public BinarySensorEntity PhoneVincentWifiState => new(_haContext, "binary_sensor.phone_vincent_wifi_state");
...
public partial class ButtonEntities
{
    ...
    ///<summary>Badkamer Battery replaced</summary>
    ...
    ///<summary>Gang Battery replaced</summary>
    ...
    ///<summary>Hal Battery replaced</summary>
    ...
    ///<summary>Keuken afstandbediening Battery replaced</summary>
    ...
    ///<summary>RollerBlind 0001 Battery replaced</summary>
    public ButtonEntity Rollerblind0001BatteryReplaced => new(_haContext, "button.rollerblind_0001_battery_replaced");
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>netdaemon_pokemon_manager</summary>
    public InputBooleanEntity NetdaemonPokemonManager => new(_haContext, "input_boolean.netdaemon_pokemon_manager");
...
public partial class LightEntities
{
    ...
    ///<summary>Kerstboom</summary>
    public LightEntity HueGradientStringLight1 => new(_haContext, "light.hue_gradient_string_light_1");
...
public partial class MediaPlayerEntities
{
    ...
    ///<summary>Vincent-PC</summary>
    public MediaPlayerEntity VincentPc => new(_haContext, "media_player.vincent_pc");
    ///<summary>Woonkamer</summary>
...
public partial class NumberEntities
{
    ...
    ///<summary>Gang Friends Speakers alarm volume</summary>
    public NumberEntity GangFriendsSpeakersAlarmVolume => new(_haContext, "number.gang_friends_speakers_alarm_volume");
    ...
    ///<summary>Gang Speaker alarm volume</summary>
    public NumberEntity GangSpeakerAlarmVolume => new(_haContext, "number.gang_speaker_alarm_volume");
    ...
    ///<summary>PetSnowy Kattenbak Delay Schoonmaken</summary>
...
public partial class SensorEntities
{
    ...
    ///<summary>Badkamer Battery last replaced</summary>
    ...
    ///<summary>BadkamerMotion Battery type</summary>
    ...
    ///<summary>Gang Battery last replaced</summary>
    ...
    ///<summary>Gang Battery type</summary>
    ...
    ///<summary>Gang Friends Speakers alarms</summary>
    public SensorEntity GangFriendsSpeakersAlarms => new(_haContext, "sensor.gang_friends_speakers_alarms");
    ///<summary>Gang Friends Speakers device</summary>
    public SensorEntity GangFriendsSpeakersDevice => new(_haContext, "sensor.gang_friends_speakers_device");
    ///<summary>Gang Friends Speakers timers</summary>
    public SensorEntity GangFriendsSpeakersTimers => new(_haContext, "sensor.gang_friends_speakers_timers");
    ...
    ///<summary>Gang Speaker alarms</summary>
    public SensorEntity GangSpeakerAlarms => new(_haContext, "sensor.gang_speaker_alarms");
    ///<summary>Gang Speaker device</summary>
    public SensorEntity GangSpeakerDevice => new(_haContext, "sensor.gang_speaker_device");
    ///<summary>Gang Speaker timers</summary>
    public SensorEntity GangSpeakerTimers => new(_haContext, "sensor.gang_speaker_timers");
    ///<summary>Go Ahead Eagles</summary>
    public SensorEntity GoAheadEagles => new(_haContext, "sensor.go_ahead_eagles");
    ///<summary>Hal Battery last replaced</summary>
    public SensorEntity HalBatteryLastReplaced => new(_haContext, "sensor.hal_battery_last_replaced");
    ///<summary>Hal Battery type</summary>
    ...
    ///<summary>Batterijcycli</summary>
    public SensorEntity JaapBatterijcycli => new(_haContext, "sensor.jaap_batterijcycli");
    ///<summary>Keuken afstandbediening Battery last replaced</summary>
    ...
    ///<summary>Keuken afstandbediening Battery type</summary>
    ...
    ///<summary>PetSnowy Kattenbak Deo Vervangen</summary>
    public SensorEntity PetsnowyLitterboxDeoRemaining => new(_haContext, "sensor.petsnowy_litterbox_deo_remaining");
    ///<summary>PetSnowy Kattenbak Errors</summary>
    public SensorEntity PetsnowyLitterboxErrors => new(_haContext, "sensor.petsnowy_litterbox_errors");
    ///<summary>PetSnowy Kattenbak Meldingen</summary>
    public SensorEntity PetsnowyLitterboxNotifications => new(_haContext, "sensor.petsnowy_litterbox_notifications");
    ///<summary>PetSnowy Kattenbak Status</summary>
    public SensorEntity PetsnowyLitterboxStatus => new(_haContext, "sensor.petsnowy_litterbox_status");
    ///<summary>Phone Vincent Audio mode</summary>
    public SensorEntity PhoneVincentAudioMode => new(_haContext, "sensor.phone_vincent_audio_mode");
    ///<summary>Phone Vincent Battery state</summary>
    public SensorEntity PhoneVincentBatteryState => new(_haContext, "sensor.phone_vincent_battery_state");
    ///<summary>Phone Vincent Charger type</summary>
    public SensorEntity PhoneVincentChargerType => new(_haContext, "sensor.phone_vincent_charger_type");
    ///<summary>Phone Vincent Detected activity</summary>
    public SensorEntity PhoneVincentDetectedActivity => new(_haContext, "sensor.phone_vincent_detected_activity");
    ///<summary>Phone Vincent Do Not Disturb sensor</summary>
    public SensorEntity PhoneVincentDoNotDisturbSensor => new(_haContext, "sensor.phone_vincent_do_not_disturb_sensor");
    ///<summary>Phone Vincent Last notification</summary>
    public SensorEntity PhoneVincentLastNotification => new(_haContext, "sensor.phone_vincent_last_notification");
    ///<summary>Phone Vincent Next alarm</summary>
    public SensorEntity PhoneVincentNextAlarm => new(_haContext, "sensor.phone_vincent_next_alarm");
    ///<summary>Phone Vincent OS version</summary>
    public SensorEntity PhoneVincentOsVersion => new(_haContext, "sensor.phone_vincent_os_version");
    ///<summary>Phone Vincent Ringer mode</summary>
    public SensorEntity PhoneVincentRingerMode => new(_haContext, "sensor.phone_vincent_ringer_mode");
    ///<summary>Phone Vincent Security patch</summary>
    public SensorEntity PhoneVincentSecurityPatch => new(_haContext, "sensor.phone_vincent_security_patch");
    ///<summary>Phone Vincent Volume level alarm</summary>
    public SensorEntity PhoneVincentVolumeLevelAlarm => new(_haContext, "sensor.phone_vincent_volume_level_alarm");
    ///<summary>Phone Vincent Volume level call</summary>
    public SensorEntity PhoneVincentVolumeLevelCall => new(_haContext, "sensor.phone_vincent_volume_level_call");
    ///<summary>Phone Vincent Volume level DTMF</summary>
    public SensorEntity PhoneVincentVolumeLevelDtmf => new(_haContext, "sensor.phone_vincent_volume_level_dtmf");
    ///<summary>Phone Vincent Volume level music</summary>
    public SensorEntity PhoneVincentVolumeLevelMusic => new(_haContext, "sensor.phone_vincent_volume_level_music");
    ///<summary>Phone Vincent Volume level notification</summary>
    public SensorEntity PhoneVincentVolumeLevelNotification => new(_haContext, "sensor.phone_vincent_volume_level_notification");
    ///<summary>Phone Vincent Volume level ringer</summary>
    public SensorEntity PhoneVincentVolumeLevelRinger => new(_haContext, "sensor.phone_vincent_volume_level_ringer");
    ///<summary>Phone Vincent Volume level system</summary>
    public SensorEntity PhoneVincentVolumeLevelSystem => new(_haContext, "sensor.phone_vincent_volume_level_system");
    ///<summary>Phone Vincent WiFi connection</summary>
    public SensorEntity PhoneVincentWifiConnection => new(_haContext, "sensor.phone_vincent_wifi_connection");
    ...
    ///<summary>Hoogste vermogenspiek tijd - vandaag</summary>
    public SensorEntity PowerHighestPeakTimeToday => new(_haContext, "sensor.power_highest_peak_time_today");
    ///<summary>Hoogste vermogenspiek tijd - morgen</summary>
    ...
    ///<summary>RollerBlind 0001 Battery last replaced</summary>
    public SensorEntity Rollerblind0001BatteryLastReplaced => new(_haContext, "sensor.rollerblind_0001_battery_last_replaced");
    ///<summary>RollerBlind 0001 Battery type</summary>
    public SensorEntity Rollerblind0001BatteryType => new(_haContext, "sensor.rollerblind_0001_battery_type");
    ...
    ///<summary>Switch badkamer spiegel Battery last replaced</summary>
    ...
    ///<summary>Vincent-PC _geluid Default Input Device State</summary>
    ...
    ///<summary>Vincent-PC _geluid Default Input Device Volume</summary>
    ...
    ///<summary>Vincent-PC _geluid Peak Volume</summary>
    ...
    ///<summary>Vincent-PC _windowsupdates Available Software Updates</summary>
    ...
    ///<summary>Vincent-PC _windowsupdates Driver Updates Pending</summary>
    ...
    ///<summary>Vincent-PC _windowsupdates Software Updates Pending</summary>
    ...
    ///<summary>Woonkamer Battery last replaced</summary>
    ...
    ///<summary>Woonkamer Battery type</summary>
    ...
    ///<summary>System Monitor Disk use (percent) /</summary>
    ...
    ///<summary>EnergySocket (5c2faf02a546) Totale energie import</summary>
    ...
    ///<summary>EnergySocket (5c2faf0c7564) Totale energie import</summary>
    ...
    ///<summary>EnergySocket (5c2faf0d8364) Totale energie import</summary>
    ...
    ///<summary>Energy market price Current hour</summary>
    ...
    ///<summary>Gas market price Current hour</summary>
    ...
    ///<summary>Afgeroken missies</summary>
    ...
    ///<summary>System Monitor Memory use (percent)</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie export</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie export tarief 1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie export tarief 2</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie import</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie import tarief 1</summary>
    ...
    ///<summary>P1 meter (3c39e72a64e8) Totale energie import tarief 2</summary>
    ...
    ///<summary>Phone Vincent Active notification count</summary>
    public NumericSensorEntity PhoneVincentActiveNotificationCount => new(_haContext, "sensor.phone_vincent_active_notification_count");
    ///<summary>Phone Vincent Battery level</summary>
    public NumericSensorEntity PhoneVincentBatteryLevel => new(_haContext, "sensor.phone_vincent_battery_level");
    ///<summary>Phone Vincent Bluetooth connection</summary>
    public NumericSensorEntity PhoneVincentBluetoothConnection => new(_haContext, "sensor.phone_vincent_bluetooth_connection");
    ///<summary>Phone Vincent Internal storage</summary>
    public NumericSensorEntity PhoneVincentInternalStorage => new(_haContext, "sensor.phone_vincent_internal_storage");
    ///<summary>Phone Vincent Mobile Rx GB</summary>
    public NumericSensorEntity PhoneVincentMobileRxGb => new(_haContext, "sensor.phone_vincent_mobile_rx_gb");
    ///<summary>Phone Vincent Mobile Tx GB</summary>
    public NumericSensorEntity PhoneVincentMobileTxGb => new(_haContext, "sensor.phone_vincent_mobile_tx_gb");
    ///<summary>Phone Vincent Sleep confidence</summary>
    public NumericSensorEntity PhoneVincentSleepConfidence => new(_haContext, "sensor.phone_vincent_sleep_confidence");
    ///<summary>Phone Vincent Sleep segment</summary>
    public NumericSensorEntity PhoneVincentSleepSegment => new(_haContext, "sensor.phone_vincent_sleep_segment");
    ///<summary>Phone Vincent Steps sensor</summary>
    public NumericSensorEntity PhoneVincentStepsSensor => new(_haContext, "sensor.phone_vincent_steps_sensor");
    ///<summary>Phone Vincent Total Rx GB</summary>
    public NumericSensorEntity PhoneVincentTotalRxGb => new(_haContext, "sensor.phone_vincent_total_rx_gb");
    ///<summary>Phone Vincent Total Tx GB</summary>
    public NumericSensorEntity PhoneVincentTotalTxGb => new(_haContext, "sensor.phone_vincent_total_tx_gb");
    ///<summary>Phone Vincent WiFi link speed</summary>
    public NumericSensorEntity PhoneVincentWifiLinkSpeed => new(_haContext, "sensor.phone_vincent_wifi_link_speed");
    ...
    ///<summary>Geschatte energieproductie - nu</summary>
    ...
    ///<summary>RollerBlind 0001 Batterij</summary>
...
public partial class SwitchEntities
{
    ...
    ///<summary>Gang Friends Speakers Do Not Disturb</summary>
    public SwitchEntity GangFriendsSpeakersDoNotDisturb => new(_haContext, "switch.gang_friends_speakers_do_not_disturb");
    ...
    ///<summary>Gang Speaker Do Not Disturb</summary>
    public SwitchEntity GangSpeakerDoNotDisturb => new(_haContext, "switch.gang_speaker_do_not_disturb");
...
public partial class UpdateEntities
{
    ...
    ///<summary>Bazarr NAS Update</summary>
    public UpdateEntity BazarrNasUpdate => new(_haContext, "update.bazarr_nas_update");
...
public partial class TodoEntities
{
    ...
    public TodoEntity HomeAssistant => new(_haContext, "todo.home_assistant");
    ///<summary>Picnic: Ida Gerhardtlaan 28 Shopping cart</summary>
    public TodoEntity PicnicIdaGerhardtlaan28ShoppingCart => new(_haContext, "todo.picnic_ida_gerhardtlaan_28_shopping_cart");
    ///<summary>Vincent maarschalkerweerd&apos;s list</summary>
    public TodoEntity VincentMaarschalkerweerdSList2 => new(_haContext, "todo.vincent_maarschalkerweerd_s_list_2");
}
...
public partial class BatteryNotesServices
{
    ...
    ///<summary>Set the battery last replaced.</summary>
    ///<param name="deviceId">Device that has had it&apos;s battery replaced.</param>
    ///<param name="datetimeReplaced">Date replaced.</param>
    public void SetBatteryReplaced(string deviceId, object? datetimeReplaced = null)
    {
        _haContext.CallService("battery_notes", "set_battery_replaced", null, new BatteryNotesSetBatteryReplacedParameters { DeviceId = deviceId, DatetimeReplaced = datetimeReplaced });
    }
}

public partial record BatteryNotesSetBatteryReplacedParameters
{
    ///<summary>Device that has had it&apos;s battery replaced.</summary>
    [JsonPropertyName("device_id")]
    public string? DeviceId { get; init; }

    ///<summary>Date replaced.</summary>
    [JsonPropertyName("datetime_replaced")]
    public object? DatetimeReplaced { get; init; }
}
...
public partial class ChimeTtsServices
{
    ...
    public void ClearCache(ChimeTtsClearCacheParameters data)
    {
        _haContext.CallService("chime_tts", "clear_cache", null, data);
    }

    ///<summary>Removes all locally cached TTS audio files created from Chime TTS</summary>
    ///<param name="clearChimesCache">Remove the cached local chime files downloaded by Chime TTS eg: True</param>
    ///<param name="clearTempTtsCache">Remove the local temporary audio files stored in the Chime TTS cache eg: True</param>
    ///<param name="clearWwwTtsCache">Remove the publicly accessible audio files stored in the Chime TTS cache eg: True</param>
    ///<param name="clearHaTtsCache">Remove the TTS audio files stored in the Home Assistant TTS cache eg: True</param>
    public void ClearCache(bool? clearChimesCache = null, bool? clearTempTtsCache = null, bool? clearWwwTtsCache = null, bool? clearHaTtsCache = null)
    {
        _haContext.CallService("chime_tts", "clear_cache", null, new ChimeTtsClearCacheParameters { ClearChimesCache = clearChimesCache, ClearTempTtsCache = clearTempTtsCache, ClearWwwTtsCache = clearWwwTtsCache, ClearHaTtsCache = clearHaTtsCache });
    }

    ///<summary>Play an audio file before TTS audio</summary>
    ///<param name="target">The target for this service call</param>
    public void Say(ServiceTarget target, ChimeTtsSayParameters data)
    {
        _haContext.CallService("chime_tts", "say", target, data);
    }

    ///<summary>Play an audio file before TTS audio</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="chimePath">A preset or custom audio file to be played before TTS audio eg: custom_components/chime_tts/mp3s/bells.mp3</param>
    ///<param name="endChimePath">A preset or custom audio file to be played after TTS audio eg: custom_components/chime_tts/mp3s/tada.mp3</param>
    ///<param name="delay">Delay (ms) between the chime/s and the TTS message eg: 450</param>
    ///<param name="finalDelay">Final delay (ms) added to the end of the audio eg: 100</param>
    ///<param name="message">Text converted into TTS audio eg: Hello</param>
    ///<param name="ttsPlatform">TTS platform used to generate TTS audio eg: google_translate</param>
    ///<param name="ttsPlaybackSpeed">Playback speed of the TTS audio, between 100% - 200% eg: 125</param>
    ///<param name="volumeLevel">The volume to use when playing audio eg: 0.75</param>
    ///<param name="joinPlayers">Join media_players for simultaneous playback (for supported speakers) eg: True</param>
    ///<param name="unjoinPlayers">Release the joined media_players after playback eg: True</param>
    ///<param name="cache">Whether or not to save/reuse the generated audio file in a local cache eg: True</param>
    ///<param name="announce">Stops current media during the announcement and then resume (on supported devices) eg: True</param>
    ///<param name="audioConversion">Convert the audio to match Alexa speaker requirements, or use your own FFmpeg arguments eg: Alexa</param>
    ///<param name="language">The TTS language (supported by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: en</param>
    ///<param name="tld">The dialect Domain (supported by Google Translate) eg: com.au</param>
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public void Say(ServiceTarget target, string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, double? volumeLevel = null, bool? joinPlayers = null, bool? unjoinPlayers = null, bool? cache = null, bool? announce = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        _haContext.CallService("chime_tts", "say", target, new ChimeTtsSayParameters { ChimePath = chimePath, EndChimePath = endChimePath, Delay = delay, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, VolumeLevel = volumeLevel, JoinPlayers = joinPlayers, UnjoinPlayers = unjoinPlayers, Cache = cache, Announce = announce, AudioConversion = audioConversion, Language = language, Tld = tld, Gender = gender, Options = options });
    }

    ///<summary>Creates a public URL to an audio file generated with the `chime_tts.say` service</summary>
    public void SayUrl(ChimeTtsSayUrlParameters data)
    {
    ...
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public void SayUrl(string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, bool? cache = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        _haContext.CallService("chime_tts", "say_url", null, new ChimeTtsSayUrlParameters { ChimePath = chimePath, EndChimePath = endChimePath, Delay = delay, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, Cache = cache, AudioConversion = audioConversion, Language = language, Tld = tld, Gender = gender, Options = options });
    }
}

public partial record ChimeTtsClearCacheParameters
{
    ///<summary>Remove the cached local chime files downloaded by Chime TTS eg: True</summary>
    [JsonPropertyName("clear_chimes_cache")]
    public bool? ClearChimesCache { get; init; }

    ///<summary>Remove the local temporary audio files stored in the Chime TTS cache eg: True</summary>
    [JsonPropertyName("clear_temp_tts_cache")]
    public bool? ClearTempTtsCache { get; init; }

    ///<summary>Remove the publicly accessible audio files stored in the Chime TTS cache eg: True</summary>
    [JsonPropertyName("clear_www_tts_cache")]
    public bool? ClearWwwTtsCache { get; init; }

    ///<summary>Remove the TTS audio files stored in the Home Assistant TTS cache eg: True</summary>
    [JsonPropertyName("clear_ha_tts_cache")]
    public bool? ClearHaTtsCache { get; init; }
}

public partial record ChimeTtsSayParameters
{
    ///<summary>A preset or custom audio file to be played before TTS audio eg: custom_components/chime_tts/mp3s/bells.mp3</summary>
    [JsonPropertyName("chime_path")]
    public object? ChimePath { get; init; }

    ///<summary>A preset or custom audio file to be played after TTS audio eg: custom_components/chime_tts/mp3s/tada.mp3</summary>
    [JsonPropertyName("end_chime_path")]
    public object? EndChimePath { get; init; }

    ///<summary>Delay (ms) between the chime/s and the TTS message eg: 450</summary>
    [JsonPropertyName("delay")]
    public long? Delay { get; init; }

    ///<summary>Final delay (ms) added to the end of the audio eg: 100</summary>
    [JsonPropertyName("final_delay")]
    public long? FinalDelay { get; init; }

    ///<summary>Text converted into TTS audio eg: Hello</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }

    ///<summary>TTS platform used to generate TTS audio eg: google_translate</summary>
    [JsonPropertyName("tts_platform")]
    public object? TtsPlatform { get; init; }

    ///<summary>Playback speed of the TTS audio, between 100% - 200% eg: 125</summary>
    [JsonPropertyName("tts_playback_speed")]
    public long? TtsPlaybackSpeed { get; init; }

    ///<summary>The volume to use when playing audio eg: 0.75</summary>
    [JsonPropertyName("volume_level")]
    public double? VolumeLevel { get; init; }

    ///<summary>Join media_players for simultaneous playback (for supported speakers) eg: True</summary>
    [JsonPropertyName("join_players")]
    public bool? JoinPlayers { get; init; }

    ///<summary>Release the joined media_players after playback eg: True</summary>
    [JsonPropertyName("unjoin_players")]
    public bool? UnjoinPlayers { get; init; }

    ///<summary>Whether or not to save/reuse the generated audio file in a local cache eg: True</summary>
    [JsonPropertyName("cache")]
    public bool? Cache { get; init; }

    ///<summary>Stops current media during the announcement and then resume (on supported devices) eg: True</summary>
    [JsonPropertyName("announce")]
    public bool? Announce { get; init; }

    ///<summary>Convert the audio to match Alexa speaker requirements, or use your own FFmpeg arguments eg: Alexa</summary>
    [JsonPropertyName("audio_conversion")]
    public object? AudioConversion { get; init; }

    ///<summary>The TTS language (supported by Google Translate, Microsoft Edge TTS and Nabu Casa Cloud TTS) eg: en</summary>
    [JsonPropertyName("language")]
    public string? Language { get; init; }

    ///<summary>The dialect Domain (supported by Google Translate) eg: com.au</summary>
    [JsonPropertyName("tld")]
    public object? Tld { get; init; }

    ///<summary>Use a male or female voice (supported by Nabu Casa) eg: female</summary>
    [JsonPropertyName("gender")]
    public object? Gender { get; init; }

    ///<summary>YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</summary>
    [JsonPropertyName("options")]
    public string? Options { get; init; }
}

public partial record ChimeTtsSayUrlParameters
{
    ///<summary>A preset or custom audio file to be played before TTS audio eg: custom_components/chime_tts/mp3s/bells.mp3</summary>
    [JsonPropertyName("chime_path")]
    public object? ChimePath { get; init; }
...
public partial class EnergyzeroServices
{
    ...
    ///<summary>Request energy prices from EnergyZero.</summary>
    ...
    public void GetEnergyPrices(object configEntry, bool inclVat, object? start = null, object? end = null)
    {
    ...
    ///<summary>Request gas prices from EnergyZero.</summary>
    ...
    ///<param name="start">Specifies the date and time from which to retrieve prices. Defaults to today if omitted. eg: 2023-01-01 00:00:00</param>
    ///<param name="end">Specifies the date and time until which to retrieve prices. Defaults to today if omitted. eg: 2023-01-01 00:00:00</param>
    public void GetGasPrices(object configEntry, bool inclVat, object? start = null, object? end = null)
    {
...
public partial class EpexSpotServices
{
    ...
    public void GetHighestPriceInterval(object duration, string? deviceId = null, DateTime? earliestStart = null, long? earliestStartPost = null, DateTime? latestEnd = null, long? latestEndPost = null)
    {
    ...
    ///<param name="latestEndPost">Postponement of `Latest End Time` in days: 0 = today (default), 1 = tomorrow. eg: 0</param>
    ///<param name="duration">Required duration to complete appliance. eg: 01:30:00</param>
    public void GetLowestPriceInterval(object duration, string? deviceId = null, DateTime? earliestStart = null, long? earliestStartPost = null, DateTime? latestEnd = null, long? latestEndPost = null)
    {
...
public partial class GoogleHomeServices
{
    ...
    ///<param name="target">The target for this service call</param>
    public void RebootDevice(ServiceTarget target)
    {
        _haContext.CallService("google_home", "reboot_device", target);
    }

    ///<summary>Refresh the status of all Google Home Devices.</summary>
    public void RefreshDevices()
    {
        _haContext.CallService("google_home", "refresh_devices", null);
    }
}
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_phone_vincent integration.</summary>
    public void MobileAppPhoneVincent(NotifyMobileAppPhoneVincentParameters data)
    {
        _haContext.CallService("notify", "mobile_app_phone_vincent", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppPhoneVincent(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_phone_vincent", null, new NotifyMobileAppPhoneVincentParameters { Message = message, Title = title, Target = target, Data = data });
    }
    ...
    ///<summary>Sends a notification message using the vincent_pc service.</summary>
    public void VincentPc(NotifyVincentPcParameters data)
    {
        _haContext.CallService("notify", "vincent_pc", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void VincentPc(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "vincent_pc", null, new NotifyVincentPcParameters { Message = message, Title = title, Target = target, Data = data });
    }
}
...
public partial record NotifyMobileAppPhoneVincentParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyVincentPcParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial class RetryServices
{
    ...
    ///<summary>Perform a sequence of actions with retries on service call failures.</summary>
    ...
    ///<param name="retries">Max amount of calls (default is 7). eg: 5</param>
    ///<param name="expectedState">The expected state of the entities after any service call. eg: on</param>
    ...
    ///<param name="stateGrace">Grace period (seconds) for expected state and validation (default is 0.2). eg: 3</param>
    public void Actions(object sequence, long? retries = null, object? expectedState = null, string? validation = null, long? stateGrace = null)
    {
        _haContext.CallService("retry", "actions", null, new RetryActionsParameters { Sequence = sequence, Retries = retries, ExpectedState = expectedState, Validation = validation, StateGrace = stateGrace });
    }

    ///<summary>Retry a service call on failure.</summary>
    public void Call(RetryCallParameters data)
    {
        _haContext.CallService("retry", "call", null, data);
    }

    ///<summary>Retry a service call on failure.</summary>
    ///<param name="service">The service to retry on failure. eg: homeassistant.turn_on</param>
    ///<param name="retries">Max amount of calls (default is 7). eg: 5</param>
    ///<param name="expectedState">The expected state of the entities after the service call. eg: on</param>
    ///<param name="validation">Special template with square brackets instead of curly brackets for validating success. eg: [[ state_attr(entity_id, &apos;brightness&apos;) == 70 ]]</param>
    ///<param name="stateGrace">Grace period (seconds) for expected state and validation (default is 0.2). eg: 3</param>
    public void Call(string service, long? retries = null, object? expectedState = null, string? validation = null, long? stateGrace = null)
    {
        _haContext.CallService("retry", "call", null, new RetryCallParameters { Service = service, Retries = retries, ExpectedState = expectedState, Validation = validation, StateGrace = stateGrace });
    }
}
...
public partial record RetryActionsParameters
{
    ...
    ///<summary>Max amount of calls (default is 7). eg: 5</summary>
    [JsonPropertyName("retries")]
    public long? Retries { get; init; }

    ///<summary>The expected state of the entities after any service call. eg: on</summary>
    [JsonPropertyName("expected_state")]
    public object? ExpectedState { get; init; }
    ...
    ///<summary>Grace period (seconds) for expected state and validation (default is 0.2). eg: 3</summary>
    [JsonPropertyName("state_grace")]
    public long? StateGrace { get; init; }
}

public partial record RetryCallParameters
{
    ///<summary>The service to retry on failure. eg: homeassistant.turn_on</summary>
    ...
    ///<summary>The expected state of the entities after the service call. eg: on</summary>
    [JsonPropertyName("expected_state")]
    public object? ExpectedState { get; init; }
...
public static class ChimeTtsEntityExtensionMethods
{
    ///<summary>Play an audio file before TTS audio</summary>
    public static void Say(this IMediaPlayerEntityCore target, ChimeTtsSayParameters data)
    {
        target.CallService("say", data);
    }

    ///<summary>Play an audio file before TTS audio</summary>
    public static void Say(this IEnumerable<IMediaPlayerEntityCore> target, ChimeTtsSayParameters data)
    {
        target.CallService("say", data);
    }
    ...
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public static void Say(this IMediaPlayerEntityCore target, string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, double? volumeLevel = null, bool? joinPlayers = null, bool? unjoinPlayers = null, bool? cache = null, bool? announce = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        target.CallService("say", new ChimeTtsSayParameters { ChimePath = chimePath, EndChimePath = endChimePath, Delay = delay, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, VolumeLevel = volumeLevel, JoinPlayers = joinPlayers, UnjoinPlayers = unjoinPlayers, Cache = cache, Announce = announce, AudioConversion = audioConversion, Language = language, Tld = tld, Gender = gender, Options = options });
    }
...
{
    ///<summary>Reboot a Google Home device.</summary>
    public static void RebootDevice(this ISensorEntityCore target)
    {
        target.CallService("reboot_device");
    }

    ///<summary>Reboot a Google Home device.</summary>
    public static void RebootDevice(this IEnumerable<ISensorEntityCore> target)
    {
        target.CallService("reboot_device");
    }
}
