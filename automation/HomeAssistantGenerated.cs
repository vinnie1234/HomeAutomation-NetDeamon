...
//   At: 2024-01-07T15:52:32.7843700+01:00
//
...
public partial class ButtonEntities
{
    ...
    ///<summary>Vincent-PC _afsluiten</summary>
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>vincent_pc_afsluiten</summary>
...
public partial class CounterEntities
{
    ...
    ///<summary>LastWaterUsageInLiter</summary>
    public CounterEntity Lastwaterusageinliter => new(_haContext, "counter.lastwaterusageinliter");
}
...
public partial class AsusrouterServices
{
    ...
    public void DeviceInternetAccess(object state, string? entities = null)
    {
...
public partial class PersonServices
{
    ...
    public void AddDeviceTracker(string entityId, string deviceTracker)
    {
    ...
    public void RemoveDeviceTracker(string entityId, string deviceTracker)
    {
...
public partial record PersonAddDeviceTrackerParameters
{
    ...
    public string? DeviceTracker { get; init; }
}
...
{
    ///<summary>Play an audio file before TTS audio</summary>
    public static void Say(this MediaPlayerEntity target, ChimeTtsSayParameters data)
    {
        target.CallService("say", data);
    }

    ///<summary>Play an audio file before TTS audio</summary>
    public static void Say(this IEnumerable<MediaPlayerEntity> target, ChimeTtsSayParameters data)
    {
        target.CallService("say", data);
    }
    ...
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public static void Say(this MediaPlayerEntity target, string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, double? volumeLevel = null, bool? joinPlayers = null, bool? unjoinPlayers = null, bool? cache = null, bool? announce = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
    ...
    ///<param name="gender">Use a male or female voice (supported by Nabu Casa) eg: female</param>
    ///<param name="options">YAML Options to pass to TTS services (will override `tld` and `gender` fields) eg: tld: com.au gender: female</param>
    public static void Say(this IEnumerable<MediaPlayerEntity> target, string message, object ttsPlatform, object? chimePath = null, object? endChimePath = null, long? delay = null, long? finalDelay = null, long? ttsPlaybackSpeed = null, double? volumeLevel = null, bool? joinPlayers = null, bool? unjoinPlayers = null, bool? cache = null, bool? announce = null, object? audioConversion = null, string? language = null, object? tld = null, object? gender = null, string? options = null)
    {
        target.CallService("say", new ChimeTtsSayParameters { ChimePath = chimePath, EndChimePath = endChimePath, Delay = delay, FinalDelay = finalDelay, Message = message, TtsPlatform = ttsPlatform, TtsPlaybackSpeed = ttsPlaybackSpeed, VolumeLevel = volumeLevel, JoinPlayers = joinPlayers, UnjoinPlayers = unjoinPlayers, Cache = cache, Announce = announce, AudioConversion = audioConversion, Language = language, Tld = tld, Gender = gender, Options = options });
    }
}
...
{
    ///<summary>Reboot a Google Home device.</summary>
    public static void RebootDevice(this SensorEntity target)
    {
        target.CallService("reboot_device");
    }

    ///<summary>Reboot a Google Home device.</summary>
    public static void RebootDevice(this IEnumerable<SensorEntity> target)
    {
        target.CallService("reboot_device");
    }
}
...
public static class VacuumEntityExtensionMethods
{
    ...
    ///<summary>Toggles the vacuum cleaner on/off.</summary>
    public static void Toggle(this VacuumEntity target)
    {
        target.CallService("toggle");
    }

    ///<summary>Toggles the vacuum cleaner on/off.</summary>
    public static void Toggle(this IEnumerable<VacuumEntity> target)
    {
        target.CallService("toggle");
    }
