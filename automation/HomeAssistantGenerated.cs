...
//   At: 2023-03-27T09:36:12.2918410+02:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>RT-AX88U-BA18 wan status</summary>
    public BinarySensorEntity RtAx88uBa18WanStatus => new(_haContext, "binary_sensor.rt_ax88u_ba18_wan_status");
    ...
    ///<summary>VINCENT-NAS Security Status</summary>
...
public partial class DeviceTrackerEntities
{
    ...
    public DeviceTrackerEntity E9eCd3e063079 => new(_haContext, "device_tracker.9e_cd_3e_06_30_79");
...
public partial class NumberEntities
{
    ...
    ///<summary>ZEDAR manual feed amount</summary>
...
public partial class PersistentNotificationEntities
{
    ...
    public PersistentNotificationEntity GrafanaUpdate => new(_haContext, "persistent_notification.grafana_update");
}
...
public partial class SensorEntities
{
    ...
    ///<summary>RT-AX88U-BA18 External IP</summary>
    public SensorEntity RtAx88uBa18ExternalIp => new(_haContext, "sensor.rt_ax88u_ba18_external_ip");
    ...
    ///<summary>RT-AX88U-BA18 KiB/s received</summary>
    public NumericSensorEntity RtAx88uBa18KibSReceived => new(_haContext, "sensor.rt_ax88u_ba18_kib_s_received");
    ///<summary>RT-AX88U-BA18 KiB/s sent</summary>
    public NumericSensorEntity RtAx88uBa18KibSSent => new(_haContext, "sensor.rt_ax88u_ba18_kib_s_sent");
    ///<summary>RT-AX88U-BA18 Uptime</summary>
    public NumericSensorEntity RtAx88uBa18Uptime => new(_haContext, "sensor.rt_ax88u_ba18_uptime");
...
public partial class SwitchEntities
{
    ...
    ///<summary>RT-AX88U Guest 2.4 GHz 2</summary>
...
public partial class InputNumberServices
{
    ...
    ///<summary>Decrease an input number entity value by a certain amount.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="step">The step to decrease the input number with. If not provided, the step of the number entity will be used.</param>
    public void Decrement(ServiceTarget target, long? @step = null)
    {
        _haContext.CallService("input_number", "decrement", target, new InputNumberDecrementParameters{Step = @step});
    }
    ...
    ///<summary>Increase an input number entity value by a certain amount.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="step">The step to increase the input number with. If not provided, the step of the number entity will be used.</param>
    public void Increment(ServiceTarget target, long? @step = null)
    {
        _haContext.CallService("input_number", "increment", target, new InputNumberIncrementParameters{Step = @step});
    }
...
{
    ///<summary>The step to decrease the input number with. If not provided, the step of the number entity will be used.</summary>
    [JsonPropertyName("step")]
    public long? Step { get; init; }
}
...
{
    ///<summary>The step to increase the input number with. If not provided, the step of the number entity will be used.</summary>
    [JsonPropertyName("step")]
    public long? Step { get; init; }
}
...
public partial class NumberServices
{
    ...
    ///<summary>Decrease a number entity value by a certain amount.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="step">The step to decrease the number with. If not provided, the step of the number entity will be used.</param>
    public void Decrement(ServiceTarget target, long? @step = null)
    {
        _haContext.CallService("number", "decrement", target, new NumberDecrementParameters{Step = @step});
    }
    ...
    ///<summary>Increase a number entity value by a certain amount.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="step">The step to increase the number with. If not provided, the step of the number entity will be used.</param>
    public void Increment(ServiceTarget target, long? @step = null)
    {
        _haContext.CallService("number", "increment", target, new NumberIncrementParameters{Step = @step});
    }
...
{
    ///<summary>The step to decrease the number with. If not provided, the step of the number entity will be used.</summary>
    [JsonPropertyName("step")]
    public long? Step { get; init; }
}
...
{
    ///<summary>The step to increase the number with. If not provided, the step of the number entity will be used.</summary>
    [JsonPropertyName("step")]
    public long? Step { get; init; }
}
...
public static class InputNumberEntityExtensionMethods
{
    ...
    ///<param name="step">The step to decrease the input number with. If not provided, the step of the number entity will be used.</param>
    public static void Decrement(this InputNumberEntity target, long? @step = null)
    {
        target.CallService("decrement", new InputNumberDecrementParameters{Step = @step});
    }

    ///<summary>Decrease an input number entity value by a certain amount.</summary>
    ///<param name="target">The IEnumerable<InputNumberEntity> to call this service for</param>
    ///<param name="step">The step to decrease the input number with. If not provided, the step of the number entity will be used.</param>
    public static void Decrement(this IEnumerable<InputNumberEntity> target, long? @step = null)
    {
        target.CallService("decrement", new InputNumberDecrementParameters{Step = @step});
    }
    ...
    ///<param name="target">The InputNumberEntity to call this service for</param>
    ///<param name="step">The step to increase the input number with. If not provided, the step of the number entity will be used.</param>
    public static void Increment(this InputNumberEntity target, long? @step = null)
    {
        target.CallService("increment", new InputNumberIncrementParameters{Step = @step});
    }

    ///<summary>Increase an input number entity value by a certain amount.</summary>
    ///<param name="target">The IEnumerable<InputNumberEntity> to call this service for</param>
    ///<param name="step">The step to increase the input number with. If not provided, the step of the number entity will be used.</param>
    public static void Increment(this IEnumerable<InputNumberEntity> target, long? @step = null)
    {
        target.CallService("increment", new InputNumberIncrementParameters{Step = @step});
    }
...
public static class NumberEntityExtensionMethods
{
    ...
    ///<param name="step">The step to decrease the number with. If not provided, the step of the number entity will be used.</param>
    public static void Decrement(this NumberEntity target, long? @step = null)
    {
        target.CallService("decrement", new NumberDecrementParameters{Step = @step});
    }

    ///<summary>Decrease a number entity value by a certain amount.</summary>
    ///<param name="target">The IEnumerable<NumberEntity> to call this service for</param>
    ///<param name="step">The step to decrease the number with. If not provided, the step of the number entity will be used.</param>
    public static void Decrement(this IEnumerable<NumberEntity> target, long? @step = null)
    {
        target.CallService("decrement", new NumberDecrementParameters{Step = @step});
    }
    ...
    ///<param name="target">The NumberEntity to call this service for</param>
    ///<param name="step">The step to increase the number with. If not provided, the step of the number entity will be used.</param>
    public static void Increment(this NumberEntity target, long? @step = null)
    {
        target.CallService("increment", new NumberIncrementParameters{Step = @step});
    }

    ///<summary>Increase a number entity value by a certain amount.</summary>
    ///<param name="target">The IEnumerable<NumberEntity> to call this service for</param>
    ///<param name="step">The step to increase the number with. If not provided, the step of the number entity will be used.</param>
    public static void Increment(this IEnumerable<NumberEntity> target, long? @step = null)
    {
        target.CallService("increment", new NumberIncrementParameters{Step = @step});
    }
