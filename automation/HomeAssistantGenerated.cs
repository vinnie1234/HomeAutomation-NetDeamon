...
//   At: 2023-09-06T01:33:07.0577170+02:00
//
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>dev_netdaemon_alarm</summary>
    public InputBooleanEntity DevNetdaemonAlarm => new(_haContext, "input_boolean.dev_netdaemon_alarm");
    ///<summary>dev_netdaemon_away_manager</summary>
    public InputBooleanEntity DevNetdaemonAwayManager => new(_haContext, "input_boolean.dev_netdaemon_away_manager");
    ///<summary>dev_netdaemon_bath_room_light_on_movement</summary>
    public InputBooleanEntity DevNetdaemonBathRoomLightOnMovement => new(_haContext, "input_boolean.dev_netdaemon_bath_room_light_on_movement");
    ///<summary>dev_netdaemon_battery_monitoring</summary>
    public InputBooleanEntity DevNetdaemonBatteryMonitoring => new(_haContext, "input_boolean.dev_netdaemon_battery_monitoring");
    ///<summary>dev_netdaemon_bed_room_lights</summary>
    public InputBooleanEntity DevNetdaemonBedRoomLights => new(_haContext, "input_boolean.dev_netdaemon_bed_room_lights");
    ...
    ///<summary>dev_netdaemon_gaming</summary>
    public InputBooleanEntity DevNetdaemonGaming => new(_haContext, "input_boolean.dev_netdaemon_gaming");
    ...
    ///<summary>dev_netdaemon_holiday_manager</summary>
    public InputBooleanEntity DevNetdaemonHolidayManager => new(_haContext, "input_boolean.dev_netdaemon_holiday_manager");
    ///<summary>dev_netdaemon_house_state_manager</summary>
    public InputBooleanEntity DevNetdaemonHouseStateManager => new(_haContext, "input_boolean.dev_netdaemon_house_state_manager");
    ///<summary>dev_netdaemon_living_room_lights</summary>
    public InputBooleanEntity DevNetdaemonLivingRoomLights => new(_haContext, "input_boolean.dev_netdaemon_living_room_lights");
    ///<summary>dev_netdaemon_reset</summary>
    public InputBooleanEntity DevNetdaemonReset => new(_haContext, "input_boolean.dev_netdaemon_reset");
    ///<summary>dev_netdaemon_save_in_state</summary>
    public InputBooleanEntity DevNetdaemonSaveInState => new(_haContext, "input_boolean.dev_netdaemon_save_in_state");
    ///<summary>dev_netdaemon_sleep_manager</summary>
    public InputBooleanEntity DevNetdaemonSleepManager => new(_haContext, "input_boolean.dev_netdaemon_sleep_manager");
    ...
    ///<summary>dev_netdaemon_tv</summary>
    public InputBooleanEntity DevNetdaemonTv => new(_haContext, "input_boolean.dev_netdaemon_tv");
